...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-expand-lg bg-secondary shadow-sm">
            <div class="container">
            <a href="#"><img  class="masthead-avatar mb-0" src="img/10.svg" alt=""></a>
            <!-- <a class="navbar-brand js-scroll-trigger font-weight-bold " href="#page-top" >SEN FORAGE</a> -->
           <a class="page-section-heading text-center text-uppercase text-primary mb-0 navbar-brand js-scroll-trigger font-weight-bold " href="#">SENFORAGE</a>
